...
export const MOCK_NOTIFICATIONS: any[] = [
  ...
  { id: 'n6', type: 'community', title: 'New post in Design Systems', body: 'Kris Andersson posted: "Atomic design isn\'t enough anymore"', fromUser: MOCK_USERS[3], link: '/community/design-systems', isRead: true, priority: 'low', createdAt: '2026-04-02T22:00:00Z' },
];
