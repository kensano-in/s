...
export default function ThemeEngineProvider() {
  const uiThemeVariant = useAppStore(s => s.uiThemeVariant);
  const customThemeManifest = useAppStore(s => s.customThemeManifest);
  const setUIThemeVariant = useAppStore(s => s.setUIThemeVariant);
  const setCustomThemeManifest = useAppStore(s => s.setCustomThemeManifest);
