...
const THEMES = [
  { id: 'cyan', name: 'Neon Cyan', color: '#00FFFF', freq: '440THz', desc: 'Vibrant Cyan Theme' },
  { id: 'violet', name: 'Nebula Violet', color: '#8B5CF6', freq: '620THz', desc: 'Space Violet Theme' },
  { id: 'emerald', name: 'Bio Emerald', color: '#10B981', freq: '550THz', desc: 'Vibrant Emerald Theme' },
  { id: 'rose', name: 'Aura Red', color: '#F43F5E', freq: '400THz', desc: 'Sleek Red Theme' },
  { id: 'amber', name: 'Solar Flare', color: '#F59E0B', freq: '500THz', desc: 'Vibrant Amber Theme' }
];
