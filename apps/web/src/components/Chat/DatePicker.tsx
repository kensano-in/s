        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 pt-6 pb-2">
              ...
              <button type="button" onClick={onClose} className="p-2 rounded-full hover:bg-white/5 text-white/40">
                <X size={18} />
              </button>
            </div>
...
function TimeWheel({ value, max, onChange, label }: { value: number; max: number; onChange: (v: number) => void; label: string }) {
  ...
  return (
    <div className="flex flex-col items-center gap-2">
      <button type="button" onClick={handlePrev} className="p-1 text-white/20 hover:text-indigo-400 transition-colors"><ArrowUp size={14} /></button>
      ...
      <button type="button" onClick={handleNext} className="p-1 text-white/20 hover:text-indigo-400 transition-colors"><ArrowDown size={14} /></button>
