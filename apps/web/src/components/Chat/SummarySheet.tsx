      ...
      {isOpen && (
        <>
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="absolute inset-0 z-[75] bg-black/60 backdrop-blur-sm"
            onClick={onClose}
          />
          ...
          <motion.div
            ...
            className="absolute bottom-0 inset-x-0 z-[80] mx-auto"
            style={{
              maxWidth: 520,
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-[16px] font-bold text-white">Chat Summary</h2>
