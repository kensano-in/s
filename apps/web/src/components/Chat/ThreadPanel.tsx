...
import { getThreadMessagesDB } from "@/app/(main)/messages/actions";
      ...
      {isOpen && rootMessage && (
        <>
          ...
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="absolute inset-0 z-[60] md:hidden bg-black/50"
            onClick={onClose}
          />
          ...
          <motion.div
            ...
            className={clsx(
              "absolute top-0 right-0 h-dvh z-[70] flex flex-col",
              "w-full md:w-[380px]"
            )}
            style={{
