...
import { getMediaVaultDB } from "@/app/(main)/messages/actions";
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="absolute inset-x-0 bottom-0 z-[90] flex flex-col md:inset-auto md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2"
            style={{
