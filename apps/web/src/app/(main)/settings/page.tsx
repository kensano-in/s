...
export default function SettingsIndex() {
  useEffect(() => {
    console.log("[FORENSICS] SettingsPage MOUNTED");
    return () => {
      console.log("[FORENSICS] SettingsPage UNMOUNTED");
    };
  }, []);
    ...
    return (
        <div className="flex h-full min-h-[400px] flex-col items-center justify-center text-center px-4">
            ...
            <h2 className="text-lg font-medium text-neutral-200 mb-1">Settings Overview</h2>
            <p className="text-[14px] text-neutral-500 max-w-sm">
                Select a category from the sidebar to manage your account and preferences.
            </p>
        </div>
    );
}
