      ...
      <div className="px-1 pb-4">
        ...
        <div className="flex items-center gap-4 mt-4 flex-wrap">
          <div className="karma-badge">
            ⚡ {kFmt(currentUser.karmaScore)} Karma
          </div>
          <div className="flex items-center gap-4 text-sm">
            <div className="text-center cursor-pointer hover:opacity-80 transition-opacity">
              <div className="font-bold" style={{ color: 'var(--text-primary)' }}>{kFmt(currentUser.followerCount)}</div>
              <div className="text-xs" style={{ color: 'var(--text-tertiary)' }}>Followers</div>
            </div>
            <div className="text-center cursor-pointer hover:opacity-80 transition-opacity">
              <div className="font-bold" style={{ color: 'var(--text-primary)' }}>{kFmt(currentUser.followingCount)}</div>
